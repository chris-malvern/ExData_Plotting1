...
with(data, plot(Date,Voltage, ylab='Voltage', xlab="datetime", type='l', cex.axis=0.7, cex.lab=0.7))
...
with(data, plot(Date,Global_reactive_power, ylab='Global_reactive_power', xlab="datetime", type='l', cex.axis=0.7, cex.lab=0.7))
